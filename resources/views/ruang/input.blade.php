        ...
        <form action="storeruang" method="POST" class="form-horizontal">
            ...
            <div class="card-body">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                      <input style="opacity: 80%" type="text" name="nama_ruang" class="form-control" placeholder="Nama Ruang">
                  </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><b>Kode Ruang</b></label>
                        <div class="col-sm-10">
                          <input style="opacity: 80%" type="text" name="kode_ruang" class="form-control" placeholder="Kode Ruang">
                      </div>
                </div>
                <div class="mb-3 row">
