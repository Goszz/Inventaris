      ...
      <div class="card-header">
        ...
        <form action="updateruang" method="POST" class="form-horizontal">
            ...
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><b>Nama Ruang</b></label>
                    <div class="col-sm-10">
                      <input style="opacity: 80%" type="text" name="nama_ruang" class="form-control" placeholder="Nama Ruang" value="{{ $d->nama_ruang }}">
                  </div>
                </div>
                <div class="mb-3 row">
                    <label class="col-sm-2 col-form-label"><b>Kode Ruang</b></label>
                        <div class="col-sm-10">
                          <input style="opacity: 80%" type="text" name="kode_ruang" class="form-control" placeholder="Kode Ruang"value="{{ $d->kode_ruang }}">
                      </div>
                </div>
                <div class="mb-3 row">
